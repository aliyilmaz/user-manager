...
<head>
    ...
    <title>New User | User Manager</title>
...
<body>
    ...
    <div class="m-4">
        ...
        <h2>New User</h2>
        <form action="panel/user/add" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control" id="group_name" type="text" name="group_name" placeholder="Group name">
                        </div>
                    </div>
                </div>
            ...
            <div>
                <?php 
                    $this->addLayer('app/request/panel/user/add');
                    if(isset($this->post['username'])){
                        ...
                        if(!empty($this->errors)) {
                            ...
                            echo '<strong style="color:green;">User added.</strong>';
                        }
